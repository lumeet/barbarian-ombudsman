...
Reporter.prototype.print = function(keyDiff) {
...
Reporter.prototype.printLocaleDiff = function(diff, name) {
  if (diff.length > 0) {
    console.error(
      colors.white('The following translations seem to be missing from \'') +
      colors.red(name) +
      colors.white('\':')
    );
